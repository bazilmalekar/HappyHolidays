...
namespace HappyHolidays.Core.Migrations
{
    ...
    [Migration("20250104115222_inclustionExclusion")]
    partial class inclustionExclusion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HappyHolidays.Core.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HappyHolidays.Core.ExclusionsDescription", b =>
                {
                    b.Property<int>("ExclusionsDescriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ExclusionsDescriptionId"));

                    b.Property<string>("ExclusionPoints")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ItineraryDetailsId")
                        .HasColumnType("int");

                    b.HasKey("ExclusionsDescriptionId");

                    b.HasIndex("ItineraryDetailsId");

                    b.ToTable("ExclusionsDescription");
                });

            modelBuilder.Entity("HappyHolidays.Core.InclusionsDescription", b =>
                {
                    b.Property<int>("InclusionsDescriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("InclusionsDescriptionId"));

                    b.Property<string>("InclusionPoints")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ItineraryDetailsId")
                        .HasColumnType("int");

                    b.HasKey("InclusionsDescriptionId");

                    b.HasIndex("ItineraryDetailsId");

                    b.ToTable("InclusionsDescription");
                });
            ...
            modelBuilder.Entity("HappyHolidays.Core.Package", b =>
                {
                    ...
                    b.Property<byte[]>("CardThumbNailImage")
            ...
            modelBuilder.Entity("HappyHolidays.Core.PackageDetails", b =>
                {
                    ...
                    b.Property<string>("PackageImages")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HappyHolidays.Core.ExclusionsDescription", b =>
                {
                    b.HasOne("HappyHolidays.Core.ItineraryDetails", "ItineraryDetails")
                        .WithMany("ExclusionsDescriptions")
            ...
            modelBuilder.Entity("HappyHolidays.Core.InclusionsDescription", b =>
                {
                    b.HasOne("HappyHolidays.Core.ItineraryDetails", "ItineraryDetails")
                        .WithMany("InclusionsDescriptions")
                        .HasForeignKey("ItineraryDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HappyHolidays.Core.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HappyHolidays.Core.ItineraryDetails", b =>
                {
                    b.Navigation("ExclusionsDescriptions");

                    b.Navigation("InclusionsDescriptions");
